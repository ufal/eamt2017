...
<div class="column">
	...
	<ul>
		<li>companies and institutions already using or being potential users of MT</li>
		<li>localisation companies using MT in the translation workflow</li>
		<li>renowned MT scientists and researchers</li>
		<li>companies and institutions developing MT systems</li>
		<li>R&amp;D teams from both private companies and public universities</li>
	</ul>
