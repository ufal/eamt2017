%
% File eamt17.tex, a copy of eamt17.tex
%
...
\newcommand{\confname}{EAMT 2017}
\newcommand{\website}{http://ufal.mff.cuni.cz/eamt2017/}
\newcommand{\urlwebsite}{\url{http://ufal.mff.cuni.cz/eamt2017/}}
\newcommand{\contactname}{The general chair, Mikel L.\ Forcada}
\newcommand{\contactemail}{mlf@ua.es}
\newcommand{\conffilename}{eamt17}
\newcommand{\downloadsite}{http://ufal.mff.cuni.cz/eamt2017/}
\newcommand{\paperlength}{$8$ (eight)}
\newcommand{\shortpaperlength}{$4$ (four)}

\title{Instructions for \confname\ Proceedings \\(User Studies and Project/Product
Descriptions)}
...
\begin{abstract}
  ...
  manuscript for the \emph{user studies and project/product papers} in the
...
This document is derived from the instructions for EAMT 2014 % update this list at next change
...
papers accepted for publication in \confname{} proceedings for \emph{User
Studies} and \emph{Project/Product Descriptions}.
Note that \confname{} research papers should use a different style this year.
